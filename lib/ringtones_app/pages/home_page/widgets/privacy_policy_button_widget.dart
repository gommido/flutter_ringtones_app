  ...
  Widget build(BuildContext context) {
    ...
    return CustomExpanded(
      child: CustomGestureDetector(
        onTap: (){
          context.read<HomeCubit>().onLaunchUrl(link: AppConstants.appPrivacyPolicyLink).then((value){});
        },
        child: CustomContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: ColorManager.bg1,

          ),
          child: CustomRow(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              CustomIcon(icon: Icons.info, color: ColorManager.black,),
              CustomSizedBox(width: size.width / 100,),
              CustomText(
                data: translate(context, 'privacyPolicy'),
